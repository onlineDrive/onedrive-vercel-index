...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ishare0809@gmail.com',
  ...
  protectedRoutes: ['/Personal', 'Audio_backup'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:ishare0809@gmail.com',
  ...
  links: [
    {
      name: 'Twitter',
      link: 'https://twitter.com/fanqiedamn',
    },
  ],
